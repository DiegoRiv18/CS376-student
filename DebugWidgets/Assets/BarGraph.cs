...
public class BarGraph : MonoBehaviour
{
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        if (value == 1)
        {
            BarTransform.localScale = BarTransform.localScale = new Vector3(BarTransform.localScale.y, BarTransform.localScale.y, BarTransform.localScale.z);   
        }
        if (signedDisplay == true)
        {
            BarTransform.localScale = new Vector3(BarTransform.localScale.y * value / 2, BarTransform.localScale.y, BarTransform.localScale.z);
        }
