...
public class BarGraph : MonoBehaviour
{
    ...
    private bool signedDisplay = false;
...
SetWidthPercent(value, color);
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        if (value == 0)
        {
            BarTransform.localScale = new Vector3(0, BarTransform.localScale.y,
            BarTransform.localScale.z);
        }
        if (value == 1)
        {
            BarTransform.localScale = BarTransform.localScale = new
            Vector3(BarTransform.localScale.y, BarTransform.localScale.y,
            BarTransform.localScale.z);
        }
        if (signedDisplay == true)
        {
            BarTransform.localScale = new Vector3(BarTransform.localScale.y * value
            / 2, BarTransform.localScale.y, BarTransform.localScale.z);
        }
    }
